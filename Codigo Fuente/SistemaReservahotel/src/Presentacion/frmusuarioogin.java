 ...
 * @author Rogelio A
 */
public class frmusuarioogin extends javax.swing.JFrame {

    /**
     * Creates new form frmusuarioogin
     */
    public frmusuarioogin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/File/usuario.png"))); // NOI18N
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        try {
            ...
            if (func.totalregistros >0) {
                ...
                //estas columnas recordemos que estan en nuestra clase ftrabajor y en la funciòn login.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmusuarioogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmusuarioogin().setVisible(true);
            }
        });
    }
